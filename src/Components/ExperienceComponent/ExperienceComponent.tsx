      ...
      <div className={classes[`ExperienceComponent-${theme}`]}>
        ...
        <div className={classes[`ExperienceComponent-${theme}-img`]}>
          <div className={classes[`ExperienceComponent-${theme}-img-jsMix`]}>
            <div className={classes[`ExperienceComponent-${theme}-img-jsMix-js`]} data-aos="fade-right" >
              <img src="./img/JSLOGO.png" alt="jslogo" />
            </div>
            <div className={classes[`ExperienceComponent-${theme}-img-jsMix-ts`]} data-aos="fade-left" >
              <img src="./img/TypescriptLogo.png" alt="Tslogo" />
            </div>
          </div>
          <div className={classes[`ExperienceComponent-${theme}-img-reactMix`]}>
            <div className={classes[`ExperienceComponent-${theme}-img-reactMix-react`]} data-aos="fade-right" >
              <img src="./img/reactLogo.png" alt="reactlogo" />
            </div>
            <div className={classes[`ExperienceComponent-${theme}-img-reactMix-redux`]} data-aos="fade-left" >
              <img src="./img/ReduxLogo.png" alt="reduxlogo" />
            </div>
          </div>
          <div className={classes[`ExperienceComponent-${theme}-img-arduinoMix`]}>
            <div className={classes[`ExperienceComponent-${theme}-img-arduinoMix-cpp`]} data-aos="fade-right" >
              <img src="./img/cppLogo.png" alt="c++logo-" />
            </div>
            <div className={classes[`ExperienceComponent-${theme}-img-arduinoMix-arduino`]} data-aos="fade-left" >
